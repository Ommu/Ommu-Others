...
class BookReviews extends CActiveRecord
{
	...
	{
		return array(
			'review_id' => Yii::t('attribute', 'Review'),
			'publish' => Yii::t('attribute', 'Publish'),
			'book_id' => Yii::t('attribute', 'Book'),
			'resensator_id' => Yii::t('attribute', 'Resensator'),
			'headline' => Yii::t('attribute', 'Headline'),
			'comment_code' => Yii::t('attribute', 'Comment Code'),
			...
			'resensator_search' => Yii::t('attribute', 'Resensator'),
